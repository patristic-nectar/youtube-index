...
window.patristicNectarWidget = patristicNectarWidget;
  ...
  <div x-show="!loading && !error" class="pn-main">
    ...
    <div class="pn-controls">
      ...
      <select x-model="sortBy" class="pn-select">
    ...
    <div class="pn-toolbar">
      ...
      <div style="display: flex; gap: 0.5rem;">
        <button @click="expandAll()" class="pn-btn pn-btn-sm">Expand All</button>
        <button @click="collapseAll()" class="pn-btn pn-btn-sm">Collapse All</button>
      </div>
    </div>
